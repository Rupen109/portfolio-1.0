                ...
                <section className="text-gray-600 body-font">
                    <div className="container px-5 py-24  flex flex-col items-center text-center">
                        <div className="p-4 md:w-11/12">
                            <div className="h-full bg-[#E6E6FA] shadow-2xl  p-8 rounded">
                ...
                <div className="container px-5 md:-mt-44 md:ml-48  mx-auto">
                    <div className="flex flex-wrap -m-4">
                        <div className="p-2 lg:w-3/12">
                            <div className="h-2/3 bg-[#F0F0FB] shadow-2xl shadow-cyan-300 px-8 pb-24 rounded-lg overflow-hidden text-center relative">
                        ...
                        <div className="p-2 lg:w-3/12">
                            <div className="h-2/3 bg-[#F0F0FB] shadow-2xl shadow-[#23D997] px-8  pb-24 rounded-lg overflow-hidden text-center relative">
                        ...
                        <div className="p-2 lg:w-3/12">
                            <div className="h-2/3 bg-[#F0F0FB] shadow-2xl shadow-cyan-300 px-8  p rounded-lg overflow-hidden text-center relative">
