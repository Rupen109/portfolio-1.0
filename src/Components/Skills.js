          ...
          <div className="container px-16 py-16 mx-auto">
            <div className="flex flex-wrap -m-">
              ...
              <div className="flex flex-wrap w-full flex-col items-center text-center">
                <h1 className="sm:text-6xl text-6xl md:mt-0 -mt-80  title-font mb-2 text-white">Things <span>I Love</span></h1>
              ...
              <section className="text-gray-600 body-font">
                <div className="container px-5  py-4 md:mt-4 -mt-96 mx-auto">
